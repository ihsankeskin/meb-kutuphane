        ...
        if($_POST):
           ...
           if(!$eposta) {
               ...
               if(!filter_var($eposta,FILTER_VALIDATE_EMAIL)){
                   ...
                   $varmi = $db->prepare("SELECT ad,soyad,eposta FROM ogrenciler WHERE eposta=:e");
                   ...
                   if ($varmi->rowCount()){
                       ...
                       $sifirlamlinki="http://kutuphane.ihsankeskin.org/ogrenci/sifremisifirla.php?kod=".$sifirlamakodu;

                       $sifirlamakodunuekle = $db->prepare("UPDATE ogrenciler set sifirlama_kodu=:k WHERE eposta=:e" );
